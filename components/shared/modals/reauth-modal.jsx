      ...
      <div className="w-full max-w-md p-6 mx-4 bg-white shadow-xl rounded-2xl">
        ...
        <div className="mb-6">
          ...
          <p className="mb-4 text-sm text-center text-gray-600">
            To link your <strong className="capitalize">{providerToLink}</strong> account, 
            please re-authenticate with your original <strong className="capitalize">{originalProvider}</strong> account 
            for security verification. <span className="text-green-600">Email addresses don't need to match.</span>
          </p>
          ...
          <div className="p-3 border rounded-lg bg-amber-50 border-amber-200">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p className="mt-1">
                  Re-authentication ensures that only you can link new accounts to your profile, 
                  preventing unauthorized access even if someone gains temporary access to your session.
                  This works with any email address - they don't need to match.
                </p>
              </div>
            </div>
          </div>
