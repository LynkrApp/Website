              ...
              {!showName ? (
                items.map((item) => (
                  <nav key={item.title} className="rounded-xl">
                    <Link href={item.href}>
                      <div className="flex items-center p-2 space-x-2 bg-transparent hover:bg-slate-100 rounded-xl">
                        {item.icon}
            ...
            <div className="flex items-center p-1 space-x-6">
              {items?.map((item) => (
                <React.Fragment key={item.title}>
                  <nav key={item.title} className="rounded-xl">
                    <Link href={item.href}>
                      <div className="flex flex-col items-center p-2 bg-transparent hover:bg-slate-100 rounded-xl">
                        {item.icon}
